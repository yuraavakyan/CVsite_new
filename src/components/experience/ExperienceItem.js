...
const ExperienceItem = (props) => {
    ...
    return (
            ...
            <div className={`${index % 2 === 0 ? "experienceItem-reverse" : "experienceItem"}`} data-aos="fade-left" once="false">
            <div className={`${index % 2 === 0 ? "experience-item-container" : "experience-item-container-rev"}`}>
